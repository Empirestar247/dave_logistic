...
function Form() {
    ...
    return (
        <>
            <form onSubmit={handleSubmit}> {/* Added onSubmit attribute */}
                <div className="d-flex mt-3">
                    ...
                    <div className="flex-grow-1 ms-2">
                        <input type="text" name="email" value={formData.email} placeholder="Email" className={`form-control ${errors.email && 'is-invalid'}`} onChange={handleChange} />
                        {errors.email && <div className='invalid-feedback'>{errors.email}</div>}
                    </div>
                </div>
                <div className="d-flex mt-3">
                    <div className="flex-grow-1 me-2">
                        <input type="text" name="phone" value={formData.phone} placeholder="Phone (Optional)" className="form-control" /> {/* Fixed class name */}
                    </div>
                    <div className="flex-grow-1 ms-2">
                ...
                <button type="submit" className="btn btn-danger mt-3">Submit</button> {/* Added type="submit" */}
            </form>
        </>
    );
}
